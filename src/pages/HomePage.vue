<template>
    <div class="edbg container-fluid q-pt-xl q-pb-xl">
        ...
        <div class="container-fluid q-pt-xl q-pb-xl">
            <div class="container">
                <div class="row q-pl-xl">
                    <p class="mainsecnd text-weight-bolder">Recent Jobs</p>
                </div>
                    ...
                    <q-card style="width: 350px;">
                        <div class="row q-pa-sm justify-between">
                            ...
                            <div class="col-9">
                                ...
                                <span><q-icon name="work"></q-icon>2yrs &nbsp;
                                    <q-icon name="money"></q-icon>1lac/yr &nbsp;
                                    <q-icon name="chair"></q-icon>10 &nbsp;
            ...
            <div class="container q-pb-xl q-pt-xl">
                <div class="row">
                    ...
                    <div class="col-md-5 col-12 text-center">
                        ...
                        <div><img class="lt-md fit q-pt-xl"  src="../assets/edlog-3.jpeg"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="container-fluid q-pt-xl q-pb-xl">
            <div class="container">
                <div class="row q-pl-xl">
                    <div class="col-md-5 col-12 q-pt-xl">
                        <div>
                    ...
                    <div class="col-md-7 col-12 q-pt-xl">
                        ...
                        <div class="q-pt-md btclr"><q-btn class="but text-h6 text-white text-weight-bolder">View Jobs</q-btn></div>
                    </div>
                </div>
            </div>
        </div>
